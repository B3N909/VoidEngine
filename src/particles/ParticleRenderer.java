...
public class ParticleRenderer
{
	...
	protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix)
	{
		...
		quad = loader.asVAO(VERTICES, 2);
		loader.addInstanceAtrribute(quad.getVaoID(), vbo, 1, 4, INSTANCE_DATA_LENGTH, 0);
		loader.addInstanceAtrribute(quad.getVaoID(), vbo, 2, 4, INSTANCE_DATA_LENGTH, 4);
		loader.addInstanceAtrribute(quad.getVaoID(), vbo, 3, 4, INSTANCE_DATA_LENGTH, 8);
		loader.addInstanceAtrribute(quad.getVaoID(), vbo, 4, 4, INSTANCE_DATA_LENGTH, 12);
		loader.addInstanceAtrribute(quad.getVaoID(), vbo, 5, 4, INSTANCE_DATA_LENGTH, 16);
		loader.addInstanceAtrribute(quad.getVaoID(), vbo, 6, 1, INSTANCE_DATA_LENGTH, 20);
	...
	{
		if (texture.usesAdditiveBlending()) GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE);
