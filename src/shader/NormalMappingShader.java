...
public class NormalMappingShader extends ShaderProgram{
	...
	public static String vertexFile = "src/normalMappingRenderer/normalMapVShader.txt";
	public static String fragmentFile = "src/normalMappingRenderer/normalMapFShader.txt";
