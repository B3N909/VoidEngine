...
public class Terrain
{
	...
	public void create(String heightMap)
	{
		isInfinite = false;
	...
	{
		isInfinite = true;
		this.model = generateProceduralTerrain();
	}
	...
	private RawModel generateTerrain()
	{
		...
		for(int i=0;i<VERTEX_COUNT;i++)
		{
			for(int j=0;j<VERTEX_COUNT;j++)
			{
				...
				Vector3f normal = getNormal(j, i, image);
		...
		return loader.asVAO(vertices, textureCoords, normals, indices);
	}
	
	private RawModel generateProceduralTerrain()
	{
	...
	private Vector3f getNormal(int x, int y, HeightsGenerator generator)
	{
